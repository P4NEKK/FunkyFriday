...
local ThemeManager = {} do
	...
	function ThemeManager:CreateThemeManager(groupbox)
		...
		groupbox:AddLabel('Main Window')	:AddColorPicker('MainColor', { Default = self.Library.MainColor });
		groupbox:AddLabel('Borders'):AddColorPicker('AccentColor', { Default = self.Library.AccentColor });
		...
		groupbox:AddDivider()
		groupbox:AddInput('ThemeManager_CustomThemeName', { Text = 'New Theme Name' })
